...
export default function Home() {
  ...
  .eyebrow {
    ...
    font-weight: 500;
    color: var(--teal-600);
    background: rgba(47,168,160,0.09);
    border: 1px solid rgba(47,168,160,0.25);
    padding: 6px 14px;
    border-radius: 100px;
    margin-bottom: 28px;
  ...
  .hero h1 span {
    background: linear-gradient(100deg, var(--navy-800), var(--teal-600));
  ...
  .btn-primary:hover {
    ...
    box-shadow: 0 12px 24px -8px rgba(11,30,61,0.5);
  }
  .btn-secondary-link {
    color: var(--navy-800);
    text-decoration: none;
  ...
  .btn-secondary-link:hover { color: var(--teal-600); border-color: var(--teal-600); }
  ...
  .why {
    ...
    background-image:
      radial-gradient(circle at 15% 20%, rgba(47,168,160,0.14), transparent 45%),
  ...
  .why .section-eyebrow { color: var(--teal-500); }
  ...
  .faq-item:hover { border-color: var(--teal-500); }
  .faq-item summary {
    cursor: pointer;
    list-style: none;
    padding: 24px 28px;
  ...
  .contact-detail .mono { color: var(--gray-600); }
  ...
  .flow-step .dot { width: 7px; height: 7px; border-radius: 50%; background: var(--teal-500); flex-shrink: 0; }
  .flow-arrow {
    text-align: center;
    color: var(--gray-400);
    font-size: 13px;
  ...
  @media (max-width: 560px) {
    .stack-cards { grid-template-columns: 1fr; }
      ...
      <section className="section" id="services">
        <div className="wrap">
          <div className="section-head">
            ...
            <p>Slow reporting, conflicting numbers, teams that don&apos;t trust the dashboard, and AI tools that hallucinate, they usually all trace back to the same thing: the data underneath was never built to be relied on. Here&apos;s how that gets fixed.</p>
          </div>
          <div className="services-grid">
            <div className="service-card">
              <div className="service-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M2 5h16M2 10h16M2 15h10" stroke="white" strokeWidth="1.6" strokeLinecap="round"/></svg>
              </div>
              <h3>Data engineering</h3>
              <p>The plumbing that gets information from your tools and systems into one reliable place automatically, no more manual spreadsheet exports.</p>
            </div>
            <div className="service-card">
              <div className="service-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><circle cx="6" cy="6" r="2.5" stroke="white" strokeWidth="1.6"/><circle cx="14" cy="14" r="2.5" stroke="white" strokeWidth="1.6"/><path d="M8 8l4 4" stroke="white" strokeWidth="1.6"/></svg>
              </div>
              <h3>Analytics engineering</h3>
              <p>Turning raw data into agreed-upon business definitions, one version of &quot;revenue,&quot; one version of &quot;active customer,&quot; used consistently everywhere.</p>
            </div>
            <div className="service-card">
              <div className="service-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M4 16V9M10 16V4M16 16v-6" stroke="white" strokeWidth="1.6" strokeLinecap="round"/></svg>
              </div>
              <h3>Data strategy</h3>
              <p>Working with your team before any building starts, to surface the gaps and disagreements that cause bad numbers later, cheaper to catch now than after launch.</p>
            </div>
            <div className="service-card">
              <div className="service-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><rect x="3" y="3" width="6" height="6" rx="1.5" stroke="white" strokeWidth="1.6"/><rect x="11" y="11" width="6" height="6" rx="1.5" stroke="white" strokeWidth="1.6"/><path d="M9 6h5v5" stroke="white" strokeWidth="1.6"/></svg>
              </div>
              <h3>AI-ready data</h3>
              <p>Preparing your company&apos;s data so AI tools and assistants give accurate, grounded answers, instead of confidently making things up.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section section-alt" id="process">
        <div className="wrap">
          <div className="section-head">
            ...
            <p>Most data projects fail quietly, not from bad code, but from building the wrong thing because nobody asked the right questions first. Every engagement starts by surfacing those questions.</p>
          </div>
          <div className="process-track">
            <div className="process-step">
              <div className="process-step-num">01</div>
              <h3>Discovery conversation</h3>
              <p>A structured conversation about how your business actually defines success, revenue, growth, engagement, before assuming anything.</p>
            </div>
            <div className="process-step">
              <div className="process-step-num">02</div>
              <h3>Align on definitions</h3>
              <p>Surface the gaps and disagreements hiding in plain sight, the kind that cause two departments to report two different numbers.</p>
            </div>
            <div className="process-step">
              <div className="process-step-num">03</div>
              <h3>Build the foundation</h3>
              <p>Pipelines, models, and dashboards built to those agreed definitions, tested, documented, and built to last past the first demo.</p>
            </div>
            <div className="process-step">
              <div className="process-step-num">04</div>
              <h3>Hand off with confidence</h3>
              <p>Clear documentation and a system your team can maintain, not a black box only one person understands.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="why" id="why">
        <div className="wrap">
          <div className="section-head">
            <span className="section-eyebrow">Why Canonica Data</span>
            <h2>Canonical, by design</h2>
            <p>Every engagement is built around one idea, a single, trusted definition of the truth that every team and every model can rely on.</p>
          </div>
          <div className="why-grid">
            <div className="why-item">
              <span className="why-num">01</span>
              <h3>Trusted source of truth</h3>
              <p>One definition of every metric, agreed on once and reused everywhere.</p>
            </div>
            <div className="why-item">
              <span className="why-num">02</span>
              <h3>Clean data models</h3>
              <p>Dimensional structures built for clarity, not just for today&apos;s dashboard.</p>
            </div>
            <div className="why-item">
              <span className="why-num">03</span>
              <h3>Scalable architecture</h3>
              <p>Systems designed to hold up as data volume and complexity grow.</p>
            </div>
            <div className="why-item">
              <span className="why-num">04</span>
              <h3>Better decisions</h3>
              <p>Leadership teams that trust the number stop debating the number.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section faq-section">
        <div className="wrap">
          <div className="section-head">
            ...
            <h2>Questions organizations ask before fixing their data foundation</h2>
            <p>Most data challenges are not caused by a lack of tools. They come from unclear definitions, disconnected systems, and processes that were never designed to scale.</p>
          </div>

          <div className="faq-container">
            <details className="faq-item">
              <summary>Why don&apos;t our dashboards match?</summary>
              <div className="faq-answer">
                <p>Usually, the dashboard is not the problem. Different teams often create different definitions for the same metric over time.</p>
                <br />
                <p><strong>Common examples:</strong> Finance recognizes revenue one way, Sales tracks booked contracts another way, and Marketing measures pipeline differently.</p>
                <br />
                <p>Canonica helps organizations establish shared definitions so every team starts from the same trusted foundation.</p>
              </div>
            </details>

            <details className="faq-item">
              <summary>Do we need new tools to fix our data problems?</summary>
              <div className="faq-answer">
                <p>Not always. Many organizations purchase new platforms hoping technology will solve the issue, but the underlying challenge is often inconsistent data definitions or unclear ownership.</p>
                <br />
                <p>The first step is understanding your current systems, processes, and business logic before deciding what needs to change.</p>
              </div>
            </details>
            ...
            <details className="faq-item">
              ...
              <div className="faq-answer">
                <p>AI can accelerate organizations that already have reliable data foundations. It cannot fix unclear definitions or inconsistent business logic.</p>
                <br />
                <p>If your teams cannot agree on what a customer, revenue number, or business metric means, AI will inherit those same problems.</p>
              </div>
            </details>

            <details className="faq-item">
              <summary>What does &quot;canonical data&quot; actually mean?</summary>
              <div className="faq-answer">
                <p>Canonical data means creating a trusted, shared version of important business information.</p>
                <br />
                <p>Instead of every department maintaining its own definition of revenue, customers, or performance, everyone works from the same agreed-upon foundation.</p>
              </div>
            </details>

            <details className="faq-item">
              <summary>Can you work with our existing dashboards and tools?</summary>
              <div className="faq-answer">
                <p>Yes. The goal is not replacing technology for the sake of replacing technology.</p>
                <br />
                <p>Canonica focuses on improving the foundation behind your existing reporting, analytics, and AI initiatives so your tools become more reliable.</p>
              </div>
            </details>

            <details className="faq-item">
              <summary>What happens during a discovery engagement?</summary>
              <div className="faq-answer">
                <p>Before writing code, Canonica works to understand your business, systems, reporting workflows, and where trust breaks down today.</p>
                <br />
                <p>The goal is simple: <strong>build the right solution before building the technical solution.</strong></p>
              </div>
            </details>
          </div>
        </div>
      ...
      <footer>
        <div className="wrap">
          <a href="/" className="brand">
            <svg className="brand-mark" viewBox="0 0 100 100" fill="none">
              <path d="M50 6 L88 27 V73 L50 94 L12 73 V27 Z" stroke="#0B1E3D" strokeWidth="4" fill="none"/>
              <circle cx="50" cy="50" r="7" fill="#2FA8A0"/>
            </svg>
            Canonica Data
          </a>
          <p className="tag">canonicadata.com &nbsp;&middot;&nbsp; &copy; 2026</p>
        </div>
      </footer>
    </>
  );
